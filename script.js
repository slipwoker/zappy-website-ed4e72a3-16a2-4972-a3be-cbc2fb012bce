document.addEventListener('DOMContentLoaded', function () {
  ...
  const SELECTOR = '.animate-on-scroll, .fade-in, .scroll-animate';
  ...
  style.textContent = [
    ...
    '.animate-on-scroll:not(.' + ANIMATION_CLASS + '){opacity:0;transform:translateY(30px);transition:opacity 0.6s ease,transform 0.6s ease;}',
    '.animate-on-scroll.' + VISIBLE_CLASS + '{opacity:1;transform:translateY(0);}'
  ].join('');
  ...
  const mutationObserver = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        const newAnimatables = node.querySelectorAll ? node.querySelectorAll(SELECTOR) : [];
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Wow show משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ed4e72a3-16a2-4972-a3be-cbc2fb012bce',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ed4e72a3-16a2-4972-a3be-cbc2fb012bce';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ed4e72a3-16a2-4972-a3be-cbc2fb012bce';
